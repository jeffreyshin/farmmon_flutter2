...
class ZoomableChart2 extends StatefulWidget {
  ZoomableChart2({
    super.key,
    required this.maxX,
    required this.builder,
  ...
  @override
  State<ZoomableChart2> createState() => _ZoomableChartState2();
}

class _ZoomableChartState2 extends State<ZoomableChart2> {
  late double minX;
  late double maxX;
